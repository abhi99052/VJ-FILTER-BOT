...
API_ID = int(environ.get('API_ID', '14779078'))
API_HASH = environ.get('API_HASH', '2d80fc55cd86f7985aa0171c208b0d60')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6800148525').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002447543675'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002355400691').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://suhel23h:DzWAwEhYYzHiputr@cluster0.r5pr4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://suhel23h:DzWAwEhYYzHiputr@cluster0.r5pr4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
